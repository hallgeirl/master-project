...
A major part of this project is to extending the snow simulator developed at the HPC lab at NTNU, to support taking in meshes (mainly roads, but may be arbitrary meshes). 
