...
\end{equation}
A plot of a clothoid is shown in figure \ref{fig:back_clothoid}. 
...
The trajectory is modelled as a clothoid spline\cite{roadgen}, which is a particular class of curves where the curvature varies linearly with the position along the curve\cite{clothoid}.
