...
All vector cores may access a global memory, analogous to a regular computer's main memory. However, even though the bandwidth is huge (> 100GB/s for modern NVIDIA Tesla GPUs)\cite{foocite}, the latency is enormous, of hundreds of cycles.\cite{gpumemlatency} This neccessitates faster on-chip memory. 
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth]{figure/gpu_memory_model}
