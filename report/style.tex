...
\usepackage{amsthm}                   % Teoremer og lignende.
...
% *************** Table setting ***************
%set the height of each row, 1*default 12pt
...
\makechapterstyle{mychapterstyle}{%
    ...
    \renewcommand{\printchaptertitle}[1]{%
        \chaptitlefont\hrule height 0.5pt \vspace{0.75em}%
        \raggedright {##1}\vspace{0.75em}\hrule height 0.5pt%
        }%
    \renewcommand{\printchapternum}{%
    	\ifanappendix
			\raggedleft\space\thechapter%
		\else%
			\raggedleft\space\chapnumfont\thechapter%
		\fi%        
     }%     
}
...
\makeevenhead{empty}{\thepage}{}{\small\slshape\leftmark}
\makeoddhead{empty}{\small\slshape\rightmark}{}{\thepage}
\makeoddfoot{empty}{}{}{}
\makeheadrule{empty}{\textwidth}{0.02cm}
...
% *************** addtable ***************
\newcommand{\addTableFromFigure}[2]{
	 \begin{table}[h!]
		\begin{center}
		\includegraphics[#1]{#2}
		\end{center}
...
\newcommand{\addTableFromFigures}[4]{
	 \begin{table}[h!]
		\begin{center}
		\vspace{-10pt}
		\caption{#4}
...
%\renewcommand{\glossarysection}[4]{}
